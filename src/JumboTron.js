  ...
  return (
    <Container fluid className="bg-navy white tc pv4 jumbotron">
      ...
      <p className=" f4 fw5">
        ...
        provide assistance on how to close them. This introspection session is
        for you to think about and reflect on your individual P3 journey, in the
      ...
      <button className="br4 b--transparent f3 mt3 ph5 pv2 bg-green white">
        Take the Survey
      </button>
    </Container>
  );
